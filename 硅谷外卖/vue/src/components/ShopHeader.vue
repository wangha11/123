<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{background:`url(${info.bgImg})`}">
    ...
    <div class="shop-content">
      ...
      />
      <div class="header-content" @click="merchant = true">
    ...
    <div class="shop-header-discounts" @click="youhui = true" v-if="info.supports">
    ...
    <div class="shop-brief-modal" v-show="merchant">
    ...
    <div class="activity-sheet" v-show="youhui">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item activity-green"  :class="supportClasses[v.type]"
          v-for="(v,i) of info.supports" :key="i">
            <span class="content-tag">
              <span class="mini-tag">{{v.name}}</span>
            </span>
        ...
        <div class="activity-sheet-close" @click="youhui = false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
