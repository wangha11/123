...
<div class="activity">
<div class="activity-item" :class="colorList[act.type]"
 v-for="(act,index) in info.supports" :key="index">
    <span class="content-tag">
    <span class="mini-tag">{{act.name}}</span>
    </span>
...
<div class="pic-wrapper">
    <ul class="pic-list" ref="picsUl">
        <li class="pic-item" v-for="(v,i) in info.pics" :key="i">
...
export default {
    ...
    data() {
        return {
            colorList:['activity-green','activity-red','activity-orange']
        };
    },
